...
## parameters. It includes 31 boxes so deployments may take a while.
...
SEED = 1
NB_QUERY = 1500
EXPORT_TRACES_FILE = Path('../../results/result_scale_3_s{}.json'.format(SEED))

boxes = Boxes(depth=4, arity=2, kind=BoxesType.BALANCED)
boxes.print()
